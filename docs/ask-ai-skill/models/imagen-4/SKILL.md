...
|---|---|
| Model id | `imagen-4` |
| Best for | clean commercial photography looks (no reference images) |
| Approx. cost | ≈ $0.03 / image |
| Resolutions | fixed |
| Reference images | no |

## Prompting tips for Imagen 4

- Clean, commercial photography look — studio product shots, lifestyle scenes, stock-style imagery with a polished finish.
