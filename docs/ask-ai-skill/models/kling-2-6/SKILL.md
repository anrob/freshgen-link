...
|---|---|
| Model id | `kling-2-6` |
| Best for | clips with native audio |
| Approx. cost | ≈ $0.50 / 5s |
| Durations | 5, 10 seconds (default 5) |
| Resolutions | fixed |

## Prompting tips for Kling 2.6 (audio)

- Generates the clip WITH sound. Describe the ambience you want in the prompt ("café chatter, espresso machine hiss, soft jazz") — keep it to atmosphere, not scripted dialogue.
